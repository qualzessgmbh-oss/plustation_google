  ...
  return (
    <div className="flex-grow flex flex-col lg:flex-row h-full relative z-10 min-h-screen -mt-24 pt-24">
      ...
      <div className="w-full lg:w-1/2 px-8 py-16 lg:px-24 lg:py-24 flex flex-col justify-center bg-background-dark relative z-10">
        <div className="mb-12">
          <span className="text-primary text-xs font-bold tracking-[0.2em] uppercase block mb-4">{t('contact.getInTouch')}</span>
          <h1 className="font-display text-4xl lg:text-5xl text-white mb-6">
            {t('contact.titlePrefix')} <br />
            <span className="italic text-gray-500 font-serif">{t('contact.titleSuffix')}</span>
          </h1>
        ...
        <form className="space-y-8 max-w-lg" onSubmit={(e) => e.preventDefault()}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative group">
              <input
                ...
                required
                placeholder=" "
                className="block w-full bg-transparent border-b border-gray-700 text-white py-3 px-0 focus:outline-none focus:border-primary transition-colors peer"
              />
              <label
                htmlFor="name"
          ...
          <div className="relative group">
            ...
            >
              <option className="bg-surface-dark text-gray-300">{t('contact.subjects.general')}</option>
              <option className="bg-surface-dark text-gray-300">{t('contact.subjects.doors')}</option>
              <option className="bg-surface-dark text-gray-300">{t('contact.subjects.flooring')}</option>
              <option className="bg-surface-dark text-gray-300">{t('contact.subjects.logistics')}</option>
            </select>
          ...
          <div className="relative group">
            <textarea
              ...
              rows={4}
              placeholder=" "
              className="block w-full bg-transparent border-b border-gray-700 text-white py-3 px-0 focus:outline-none focus:border-primary transition-colors peer resize-none"
            ></textarea>
            <label
              htmlFor="message"
              className="absolute left-0 -top-3.5 text-gray-500 text-xs transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-3 peer-focus:-top-3.5 peer-focus:text-primary peer-focus:text-xs"
        ...
        <div className="mt-16 grid grid-cols-2 gap-8 border-t border-gray-800 pt-8">
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider text-white mb-2">{t('contact.contact')}</h4>
            <p className="text-sm text-gray-400 leading-relaxed">
              +49 209 1234567<br />
        ...
        <div className="absolute bottom-12 left-8 right-8 lg:left-16 lg:right-auto lg:max-w-md pointer-events-none">
          <div className="bg-black/80 backdrop-blur-sm border border-gray-800 p-8 shadow-2xl rounded-sm pointer-events-auto">
            ...
            <div className="mt-8 pt-6 border-t border-gray-800">
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">{t('contact.legalInfo')}</p>
              <div className="grid grid-cols-2 gap-4 text-xs text-gray-400">
                ...
                <div className="col-span-2">
                  <span className="block text-gray-300 font-bold">{t('contact.managingDirector')}</span>
                  Max Mustermann
                </div>
              </div>
            </div>
