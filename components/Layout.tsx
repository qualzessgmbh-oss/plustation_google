...
import { Menu, X, Search, ShoppingBag, Linkedin, Instagram, Twitter, MapPin, Phone, Mail } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-24">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <Link to="/" className={`font-display text-sm uppercase tracking-widest transition-colors duration-300 ${isActive('/')}`}>Home</Link>
                <Link to="#" className={`font-display text-sm uppercase tracking-widest transition-colors duration-300 ${isActive('/logistics')}`}>Logistics</Link>
                <Link to="/products" className={`font-display text-sm uppercase tracking-widest transition-colors duration-300 ${isActive('/products')}`}>Products</Link>
                <Link to="/contact" className={`font-display text-sm uppercase tracking-widest transition-colors duration-300 ${isActive('/contact')}`}>Contact</Link>
              </div>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-surface-dark border-t border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-primary uppercase tracking-wider">Home</Link>
              <Link to="/products" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-primary uppercase tracking-wider">Products</Link>
              <Link to="/contact" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-primary uppercase tracking-wider">Contact</Link>
            </div>
          </div>
        )}
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 text-sm max-w-sm leading-relaxed mb-6">
                German excellence in warehousing, transshipment, and premium architectural surfaces. Bringing luxury materials to your doorstep with industrial precision.
              </p>
            ...
            <div>
              <h3 className="text-white font-display text-sm tracking-widest uppercase mb-6">Collections</h3>
            ...
            <div>
              <h3 className="text-white font-display text-sm tracking-widest uppercase mb-6">Contact</h3>
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-xs tracking-wide">
              © 2024 Plustation GmbH. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <a href="#" className="text-gray-600 hover:text-gray-400 text-xs uppercase tracking-wider">Privacy</a>
              <a href="#" className="text-gray-600 hover:text-gray-400 text-xs uppercase tracking-wider">Imprint</a>
            </div>
          </div>
        </div>
      </footer>
