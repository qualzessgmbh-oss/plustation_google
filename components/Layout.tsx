          ...
          <div className="flex items-center justify-between h-24">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <Link to="/logistics" className={`font-display text-sm uppercase tracking-widest transition-colors duration-300 ${isActive('/logistics')}`}>{t('nav.logistics')}</Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-surface-dark border-t border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link to="/logistics" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-primary uppercase tracking-wider">{t('nav.logistics')}</Link>
